...
-   [Comparing Cases](/ComparingCases) -> Implement a function which takes 2 character arguments and returns boolean value indicating whether the arguments have same casing or not.
